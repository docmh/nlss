...
- [write-full-report](references/metaskills/write-full-report.md): End-to-end analysis and journal-ready reporting from a dataset plus research questions or hypotheses.
