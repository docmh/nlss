...
- `descriptive-stats` uses `nlss/assets/descriptive-stats/distribution-template.md` (default for screening).
- `plot` uses `nlss/assets/plot/default-template.md` (if visuals are requested).
- `correlations` uses `nlss/assets/correlations/default-template.md` (if used).
- `assumptions` uses `nlss/assets/assumptions/*-template.md` depending on analysis type.
- `missings` uses `nlss/assets/missings/default-template.md` (only if handling is approved).
