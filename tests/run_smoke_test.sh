...
LABEL_DATASET_PREP_SCRIPT="${ROOT_DIR}/tests/prepare_labeled_dataset.R"
CHECK_PARQUET_LABELS_SCRIPT="${ROOT_DIR}/tests/check_parquet_labels.R"
CHECK_R_ENV_SCRIPT="${ROOT_DIR}/tests/check_r_env.R"
