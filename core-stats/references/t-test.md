...
Use the Markdown template in `core-stats/assets/t-test/default-template.md` when assembling t-test reports.

### YAML template controls

- Template path can be overridden via `templates.t_test.default` in `core-stats/scripts/config.yml`.
