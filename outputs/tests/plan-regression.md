...
- `outputs/tests/data/golden_dataset.csv` (primary coverage; used to create `golden_dataset/golden_dataset.parquet`).
- `outputs/tests/data/regression_data.csv` (auto-IVs and RDS/RData fixtures).
- `outputs/tests/data/regression_semicolon.csv` (custom separator coverage).
- `outputs/tests/data/regression_no_header.csv` (header FALSE coverage).
- `outputs/tests/data/regression_group_edge.csv` (small-group invalid-input case).
...
- Template override check (config-driven regression template affects APA output).
