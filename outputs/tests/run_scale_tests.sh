...
CHECK_SCRIPT="${ROOT_DIR}/outputs/tests/check_scale_log.py"
CHECK_R_PACKAGE_SCRIPT="${ROOT_DIR}/outputs/tests/check_r_package.R"
TEMPLATE_PATH="${ROOT_DIR}/core-stats/assets/scale/default-template.md"
...
assert_contains "${APA_REPORT_PATH}" "Reverse-scored items: f1_3_rev (min = 1, max = 5)."
...
REVERSE_REPORT="${WORKSPACE_DIR}/${REVERSE_LABEL}/apa_report.md"
...
SINGLE_REPORT="${WORKSPACE_DIR}/${SINGLE_LABEL}/apa_report.md"
...
DROP_REPORT="${WORKSPACE_DIR}/${DROP_LABEL}/apa_report.md"
...
DIGITS_REPORT="${WORKSPACE_DIR}/${DIGITS_LABEL}/apa_report.md"
...
APPEND_REPORT="${WORKSPACE_DIR}/${APPEND_LABEL}/apa_report.md"
...
EOF_TEMPLATE
  ...
  TEMPLATE_REPORT="${WORKSPACE_DIR}/${TEMPLATE_LABEL}/apa_report.md"
  start_count="$(log_count "${SIMPLE_LOG_PATH}")"
...
run_ok "interactive" env CORE_STATS_PROMPT_FILE="${INTERACTIVE_INPUT}" Rscript "${R_SCRIPT_DIR}/scale.R" --interactive
