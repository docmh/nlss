...
DATA_REGRESSION_SMALL="${DATA_DIR}/data/regression_data.csv"
DATA_SEMICOLON="${DATA_DIR}/data/regression_semicolon.csv"
DATA_NO_HEADER="${DATA_DIR}/data/regression_no_header.csv"
DATA_GROUP_EDGE="${DATA_DIR}/data/regression_group_edge.csv"
...
assert_contains "${APA_REPORT_PATH}" "REGRESSION_TEMPLATE_DEFAULT"
