...
description: Agent-run NLSS format pass that standardizes a report using NLSS formatting guides and produces a journal-alike Markdown output.
license: Apache-2.0
---
...
1. `references/metaskills/formatting/headings-sections.md`
2. `references/metaskills/formatting/text-style-capitalization.md`
3. `references/metaskills/formatting/lists-seriation.md`
4. `references/metaskills/formatting/numbers-statistics.md`
5. `references/metaskills/formatting/in-text-citations.md`
6. `references/metaskills/formatting/quotations.md`
7. `references/metaskills/formatting/tables-figures.md`
8. `references/metaskills/formatting/reference-list.md`

Use `references/metaskills/formatting/` as the global reference for Markdown-compatible NLSS format rules.
...
- Ensure the final report aligns with the formatting guides in `references/metaskills/formatting/`.
